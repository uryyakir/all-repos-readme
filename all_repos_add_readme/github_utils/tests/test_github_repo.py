...
def test_generate_readme_string(get_repo_object: _Repo, constants: TestConstants) -> None:
    ...
    for version in (_none_readme_string, _string_input, _file_input):
        assert Constants.TOOL_NAME in version and constants.TOOL_SIGNATURE_STRING in version
